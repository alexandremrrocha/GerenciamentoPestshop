...
public class AtualizarAgendamento extends javax.swing.JFrame {
    ...
    private void dadosTabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dadosTabelaMouseClicked
        ...
        if(resposta == 0)
        {
            ...
            agendamento.setNomeCliente(dadosTabela.getValueAt(linha, 0).toString());
            agendamento.setNumeroAgendamento(dadosTabela.getValueAt(linha, 1).toString());
            agendamento.setNomeAnimal(dadosTabela.getValueAt(linha, 2).toString());
            agendamento.setTipoServico(dadosTabela.getValueAt(linha, 3).toString());
            agendamento.setValorTotal(dadosTabela.getValueAt(linha, 4).toString());
            agendamento.setDataAtendimento(CAgendamento.converteStringDate(dadosTabela.getValueAt(linha, 5).toString()));
            agendamento.setHoraAtendimento(dadosTabela.getValueAt(linha, 6).toString());
            agendamento.setNomeResponsavel(dadosTabela.getValueAt(linha, 7).toString());

            new AtualizarFormulario(agendamento).setVisible(true);
            dispose();
        }
